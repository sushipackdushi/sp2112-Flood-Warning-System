...
stations_by_distance([('Cambridge Jesus Lock', 'Cambridge', 0.8402364350834995),
                      ...
                      ('Dernford', 'Great Shelford', 7.993861351711722)], (52.2053, 0.1218))

stations_by_distance([('Boscadjack', 'Wendron', 440.0026482838576), ('Gwithian', 'Gwithian', 442.05491558132354),
                      ('Helston County Bridge', 'Helston', 443.37824966454974),
                      ('Loe Pool', 'Helston', 445.07184458260684), ('Relubbus', 'Relubbus', 448.64944322554413),
                      ...
                      ('Penberth', 'Penberth', 467.53367291629183)], (52.2053, 0.1218))
